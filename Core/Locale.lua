...
L["CATEGORY_NAVIGATION"]      = "Navegación"
...
L["SLASH_HELP"]               = "Comandos disponibles: /coa - Abre/Cierra la ventana principal. /coa search <texto> - Buscar. /coa version - Versión."

L["STATS_LOADING"]            = "|cffaaaaaaCargando...|r"
L["STATS_ENTRIES"]            = "|cffaaaaaa%d entradas en el Códice|r"
L["ENTRIES_COUNT"]            = "%d entradas"

L["FACTION_LABEL"]            = "|cffaaaaaaFacción:|r"
L["RACE_LABEL"]               = "|cffaaaaaaRaza:|r"
L["LOCATION_LABEL"]           = "|cffaaaaaaUbicación:|r"

L["SEARCH_RESULTS_FOR"]       = "Resultados: '%s' (%d)"
L["SEARCH_NO_RESULTS_FOR"]    = "Sin resultados para '%s'"
L["SEARCH_DID_YOU_MEAN"]     = "Quizás quisiste decir: '%s'"
